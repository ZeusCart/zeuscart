...
$result=mysql_query($sql);
$sql="CREATE TABLE admin_settings_table(set_id  INT(10) NOT NULL PRIMARY KEY AUTO_INCREMENT,set_name  VARCHAR(255) NOT NULL,set_value  TEXT(65535) NOT NULL )";
$result=mysql_query($sql);
...
$result=mysql_query($sql);
$sql="CREATE TABLE category_table(category_id  INT(15) NOT NULL PRIMARY KEY  AUTO_INCREMENT,category_name  VARCHAR(200) NOT NULL,category_parent_id  INT(15) NOT NULL,category_image  VARCHAR(255) NOT NULL,category_desc  VARCHAR(500) NOT NULL,category_status  INT(1) NOT NULL,category_content_id  INT(15) NOT NULL)";
$result=mysql_query($sql);
...
$sql="INSERT INTO mail_messages_table VALUES('1','Registration Info','<h2>Dear ==username==,<br /></h2>
...
$result=mysql_query($sql);
$sql="INSERT INTO mail_messages_table VALUES('2','Failure info','<p>Dear Customer,</p>
<hr />
<h2>Dear customer,<br /> You have not been fully registered in to ==sitename==. click here==link== to complete the registration.<br /></h2>
<p>&nbsp;</p>')"; 
$result=mysql_query($sql);
$sql="INSERT INTO mail_messages_table VALUES('3','Request password confirmation','<p>Dear ==username==,</p>
<p>&nbsp;</p>
...
<p class=\"MsoPlainText\">&nbsp;</p>')"; 
$result=mysql_query($sql);
$sql="INSERT INTO mail_messages_table VALUES('4','New temporary password','<p>Dear ==username==,</p>
<p>&nbsp;</p>
<p class=\"MsoPlainText\">You have requested for the new password we send you a new login password for the ==sitename==.</p>
<p class=\"MsoPlainText\">&nbsp;</p>
...
//$sql="INSERT INTO newsletter_subscription_table VALUES('1','testingaj@hotmail.com','0')"; 
//$result=mysql_query($sql);
...
$sql="INSERT INTO orders_status_table VALUES('1','Pending')"; 
$result=mysql_query($sql);
$sql="INSERT INTO orders_status_table VALUES('2','Processing')"; 
$result=mysql_query($sql);
$sql="INSERT INTO orders_status_table VALUES('3','Delivered')"; 
$result=mysql_query($sql);
$sql="INSERT INTO orders_status_table VALUES('4','AwaitingPayment')"; 
$result=mysql_query($sql);
...
$result=mysql_query($sql);
$sql="CREATE TABLE product_images_table(product_images_id  INT(20) NOT NULL PRIMARY KEY AUTO_INCREMENT,product_id  INT(20) NOT NULL,image_path  VARCHAR(200) NOT NULL,thumb_image_path  VARCHAR(200) NOT NULL,type  VARCHAR(40) NOT NULL)";
$result=mysql_query($sql);
...
$result=mysql_query($sql);
$sql="CREATE TABLE products_table(product_id  INT(25) NOT NULL PRIMARY KEY AUTO_INCREMENT,category_id  INT(25) NOT NULL,sku  VARCHAR(100) NOT NULL,title  VARCHAR(250) NOT NULL,description  TEXT(65535) NOT NULL ,brand  VARCHAR(100) NOT NULL,model  VARCHAR(50) NOT NULL,msrp  real NOT NULL,price  real NOT NULL,cse_enabled  INT(1) NOT NULL,cse_key varchar(100)default NULL,weight  VARCHAR(25) NOT NULL,dimension  VARCHAR(100) NOT NULL,thumb_image  VARCHAR(150) NOT NULL,image  VARCHAR(150) NOT NULL,shipping_cost  real NOT NULL,status  INT(1) NOT NULL,tag  VARCHAR(200) NOT NULL,meta_desc  VARCHAR(255) NOT NULL,meta_keywords  TEXT(65535) NOT NULL ,intro_date  date NOT NULL ,is_featured  INT(1) NOT NULL)";
$result=mysql_query($sql);
...
$result=mysql_query($sql);
$sql="CREATE TABLE shopping_cart_products_table(cart_id  INT(25) NOT NULL,product_id  VARCHAR(100) NOT NULL,product_qty  INT(10) NOT NULL,date_added  date NOT NULL ,product_unit_price  real NOT NULL,shipping_cost  real NOT NULL,original_price  real NOT NULL)";
$result=mysql_query($sql);
