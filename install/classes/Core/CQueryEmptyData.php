...
$sql="Drop table if exists orders_table";
  ...
  `shipping_street_address` varchar(64) NOT NULL,
  `shipping_suburb` varchar(32) DEFAULT NULL,
  ...
  `orders_date_closed` datetime DEFAULT NULL,
  `orders_status` int(5) NOT NULL,
  `order_total` double DEFAULT NULL,
  `order_tax` double DEFAULT NULL,
  `order_ship` double DEFAULT NULL,
  `discount` decimal(15,2) NOT NULL,
  `currency_id` int(20) NOT NULL DEFAULT '1',
  `ipn_id` int(11) NOT NULL DEFAULT '0',
  `ip_address` varchar(96) NOT NULL,
  `shipment_id_selected` int(11) NOT NULL,
  `shipment_track_id` varchar(200) NOT NULL,
