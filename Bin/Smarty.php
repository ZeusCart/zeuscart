...
class Smarty
{
     ...
     * @var string
     */
    var $left_delimiter  =  '<AJDF:output>';
     ...
     * @var string
     */
    var $right_delimiter =  '</AJDF:output>';
...
exit();
   ...
   /**
    ...
    function _smarty_include($params)
    {
        ...
        {   
             // checking for include file is exists or not for multiple template inclusion
            foreach($params as $key=>$value)
            {
                
                if($key=='smarty_include_tpl_file')
                {
                
                    $file='templates/'.$template.'/'.$params['smarty_include_tpl_file'];
        
                    if(file_exists($file))
                    {
                         $params['smarty_include_tpl_file']=''.$template.'/'.$params['smarty_include_tpl_file'];
                            
                    }
                    else
                    {
                        $params['smarty_include_tpl_file']='default/'.$params['smarty_include_tpl_file'];
