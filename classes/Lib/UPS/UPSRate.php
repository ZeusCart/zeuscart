...
class UpsShippingQuote {
	...
	**/
	public function GetShippingRate($strDestinationZip, $strServiceShortName, $strPackageLength='0', $strPackageWidth='0', $strPackageHeight='0', $strPackageWeight, $boolReturnPriceOnly=true,$shipment_accesskey,$shipment_user_id,$shipment_password) {
		...
		<AccessLicenseNumber>{$shipment_accesskey}</AccessLicenseNumber>  
		<UserId>{$shipment_user_id}</UserId>  
		<Password>{$shipment_password}</Password>  
		</AccessRequest>  
		<?xml version=\"1.0\"?>  
