	...
	if($arr['image']!='' && file_exists($arr['image']))
		...
		$output='<div style="padding-top:2px;"><div class="quickview_border">
			  ...
			  <tr>
				...
				//$_SESSION['currencysetting']['selected_currency_settings']['currency_tocken'].number_format($arr['msrp']*$_SESSION['currencysetting']['selected_currency_settings']['conversion_rate'],2)
