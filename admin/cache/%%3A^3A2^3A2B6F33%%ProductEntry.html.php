...
{
if ((document.getElementById('selcatgory').value=='') || (document.productreg.selsubcatgory.value==''))
{
...
{
if ((document.productreg.product_title.value=='') || (document.productreg.sku.value=='')||(document.productreg.cse_enabled.checked==true&&document.productreg.csekeyid.value==''))
{
...
clk('Image54','images/tab_images/images_1.jpg',6);
return false;
}
else
{
...
else if ( isNaN(document.productreg.price.value)|| isNaN(document.productreg.msrp_org.value)|| isNaN(document.productreg.shipcost.value))
{
...
if ( isNaN(document.productreg.rol.value)|| isNaN(document.productreg.soh.value))
{
...
//alert(num);
newdiv.innerHTML = "<table border='0' cellspacing='3' cellpadding='3' width='100%'><tr><td width='31%'>Sub Product Image</td><td colspan=3><input type=file name=ufile[] id=ufile[]>&nbsp;&nbsp;&nbsp;<a href=\"javascript:;\" onclick=\"removeEvent(\'"+divIdName+"\')\">Remove</a><br></td></tr></table>";
...
<tr><td>
<form name="productreg" action="?do=productentry&action=insert" method="post" enctype="multipart/form-data" onsubmit="return checkInputs()">
<input type="hidden" name="subcat" id="subcat"  />
<table cellpadding="0" cellspacing="0" width="90%" border="0" align="center">
<tr>
<td colspan="8" align="left" class="content_title">ADD PRODUCTS </td>
</tr>
<tr>
...
<tr>
<td width="40%" valign="top" class="content_form"> Select Main Category <font color="#FF0000">*</font></td>
<td align="left"><?php echo $this->_tpl_vars['dropcategory']; ?>
...
<tr>
<td width="31%" class="content_form"> Select Sub Category <font color="#FF0000">*</font></td>
<td ID="subcats" align="left"><select name="selsubcatgory" style="width:148px"><option value="0">-Select-</option></select>&nbsp;<img src="images/help.gif" onmouseover="ShowHelp('dct1', 'Sub Category', 'Select product sub category')" onmouseout="HideHelp('dct1');">
...
<td ID="subcatsunder" align="left"><select name="selsubundercatgory" style="width:148px"><option value="0">-Select-</option></select>&nbsp;<img src="images/help.gif" onmouseover="ShowHelp('dct2', 'Sub Under SubCategory', 'Select product sub under sub category')" onmouseout="HideHelp('dct2');">
...
<td><table border="0" width="60%" cellpadding="4" cellspacing="4" align="left">
<tr>
<td width="31%" class="content_form" nowrap="nowrap" align="left"> Product Name <font color="#FF0000">*</font></td>
<td colspan="3" align="left"><input name="product_title" id="product_title" value="<?php echo $this->_tpl_vars['val']['product_title']; ?>
"  type="text" size="50" />
...
<tr>
<td colspan="4" style="padding-left:140px" width="210">
<textarea name="desc" id="desc" cols="120" rows="30" >
...
<td  colspan="2" class="content_form" align="left"><table>
<tr>
<td align="left"><div id="select" name="select" style="visibility:visible; padding-left:0px; display:block"><?php echo $this->_tpl_vars['dispbrand']; ?>
</div><div id="select_new" name="select_new" style="visibility:hidden; padding-left:10px; display:none"><input type="text" name="new_brand"  /></div></td><td><div id="select1" name="select1" style="visibility:visible; display:block"><a href="javascript:change();">Others</a></div><div id="select_new1" name="select_new1" style="visibility:hidden; display:none"><a href="javascript:change1();">Others</a></div></td><td>&nbsp;<img src="images/help.gif" onmouseover="ShowHelp('dbnd', 'Brand', 'Select brand from list or click and enter new brand.')" onmouseout="HideHelp('dbnd');">
...
<td colspan="3" align="left"><input name="model" id="model"  type="text" value="<?php echo $this->_tpl_vars['val']['model']; ?>
" /></td>
</tr>
<tr>
<td class="content_form" align="left">Weight</td>
<td colspan="3" align="left"><input name="txtweight" id="txtweight"  type="text" value="<?php echo $this->_tpl_vars['val']['txtweight']; ?>
...
<TD align="left"><INPUT NAME="tag"  type="text" ID="tag" VALUE="<?php echo $this->_tpl_vars['val']['tag']; ?>
" SIZE="80"/>
<div><font size="-2">(Ex: tag1, tag2,etc..)</div></TD><td valign="top"><img src="images/help.gif" onmouseover="ShowHelp('dptag', 'Product Tags', 'The keywords that are related to product name, which is to be used while searching the product should be entered. When user enters the keyword related to the added product tags then your product will be displayed for the user. Enter the tags separated by commas.')" onmouseout="HideHelp('dptag');" style="vertical-align:top">
<div id="dptag" style="left: 50px; top: 50px;"></div></td>
</TR>
<TR>
<TD class="content_form" align="left">Introduction Date </TD>
<TD align="left"><INPUT  type="text" ID="intro_date" NAME="intro_date" VALUE="<?php echo $this->_tpl_vars['val']['intro_date']; ?>
"  />
...
<TR>
<TD class="content_form" valign="top" align="left">Is CSE Enabled </TD>
<TD class="content_form" align="left"><INPUT NAME="cse_enabled" TYPE="checkbox" ID="cse_enabled" onclick="cseshow()" <?php echo $this->_tpl_vars['val']['cse_enabled']; ?>
/>
...
<div id="dcse" style="position:fixed"></div><div id="divcsekey" style="display:none">CSE Keyword&nbsp;:&nbsp;<input type="text" id="csekeyid" name="csekeyid" value="<?php echo $this->_tpl_vars['val']['csekeyid']; ?>
" /></div><div style="color:#FF0000">
<?php echo $this->_tpl_vars['msg']['csekeyid']; ?>
</div></TD>
</TR>
<TR>
<TD class="content_form" align="left">Is Featured</TD>
<TD class="content_form" align="left"><INPUT NAME="is_feautured" TYPE="checkbox" <?php echo $this->_tpl_vars['val']['is_feautured']; ?>
/>
...
<TD class="content_form" align="left"><INPUT NAME="is__product_status" TYPE="radio" <?php echo $this->_tpl_vars['val']['is_new_product']; ?>
value='1'/>
...
<div id="dftrnew" style=" position:fixed"></div>Is Discount Product<INPUT NAME="is__product_status" TYPE="radio" <?php echo $this->_tpl_vars['val'][$this->_tpl_vars['is_discount_product']]; ?>
value='2'/>
...
<TD class="content_form" align="left"><INPUT NAME="status" TYPE="checkbox" checked="checked" />
...
<tr>
<td width="31%" class="content_form" align="left"> Main Product Image <font color="#FF0000">*</font></td>
<td colspan="3" align="left"><INPUT VALUE="0" ID="theValue" TYPE="hidden">
<INPUT NAME="ufile[0]" ID="ufile[0]"  type="file" />
&nbsp;<A HREF="javascript:;" onClick="addEvent();">Add Multiple Images</A>
<div style="color:#FF0000">
...
<tr>
<td width="31%" colspan="5"><DIV ID="myDiv"></DIV>
<A HREF="javascript:;" onClick="addEvent();"></A></TD>
</TR>
</td>
</tr>
<tr>
<td colspan="2" align="center"><input type="button" name="category" class="all_bttn" value="Back" onClick="clk('Image52','images/tab_images/general_1.jpg',5)"/>&nbsp;&nbsp;&nbsp;<input type="button" name="category" class="all_bttn" value="Continue" onClick="clk('Image55','images/tab_images/attributes_1.jpg',7)"/></td>
</tr>
</table>
</td>
</tr>
...
<TD  colspan="3" class="content_form" align="left"><input name="price" type="text" id="price" value="<?php echo $this->_tpl_vars['val']['price']; ?>
...
<TD COLSPAN="3" class="content_form" align="left"><INPUT NAME="msrp_org" TYPE="text" ID="msrp" MAXLENGTH="16" VALUE="<?php echo $this->_tpl_vars['val']['msrp_org']; ?>
...
<div align="right" style="padding-bottom:10px; width:90%"><input type="button" name="insert" class="all_bttn"  value="Add" onClick="addTier('<?php echo $this->_tpl_vars['currencycode']; ?>
');"/><INPUT VALUE="-1" ID="msrp1" TYPE="hidden"></div>
...
<td  class="content_list_head" width="25%">Actions</td>
</tr>
<!--<tr>
...
<TR>
<TD class="content_form" align="left"> Product Shipping Cost </TD>
<TD COLSPAN="4" class="content_form" align="left"><INPUT NAME="shipcost" ID="shipcost"  type="text" VALUE="<?php echo $this->_tpl_vars['val']['shipcost']; ?>
"  />&nbsp;<b>[<?php echo $this->_tpl_vars['currencycode']; ?>
...
<tr>
<td colspan="2" align="center"><input type="button" name="category" class="all_bttn" value="Back" onClick="clk('Image55','images/tab_images/attributes_1.jpg',7)"/>&nbsp;&nbsp;&nbsp;<input type="button" name="category" class="all_bttn" value="Continue" onClick="clk('Image57','images/tab_images/inventory_1.jpg',9)"/></td>
</tr>
</table>
</td>
</tr>
...
<TD align="left"><INPUT NAME="rol"  type="text" ID="rol" SIZE="10" MAXLENGTH="5" VALUE="<?php echo $this->_tpl_vars['val']['rol']; ?>
...
<TD align="left"><INPUT NAME="soh"  type="text" ID="soh" SIZE="10" VALUE="<?php echo $this->_tpl_vars['val']['soh']; ?>
...
<tr>
<td align="left">
<table border="0" width="92%" cellpadding="4" cellspacing="4" align="left">
<!--<TR>
<TD>Meta Title </TD>
<TD>
<INPUT NAME="meta_keywords" wrap="off" TYPE="text" ID="meta_keywords" VALUE="<?php echo $this->_tpl_vars['val']['meta_keywords']; ?>
"/></TD>
</TR>-->
<TR>
<TD class="content_form" align="left">Meta Keywords </TD>
<TD align="left">
<INPUT NAME="meta_keywords" wrap="off" TYPE="text" ID="meta_keywords"  size="75"  VALUE="<?php echo $this->_tpl_vars['val']['meta_keywords']; ?>
...
<TR>
<TD class="content_form" width="20%" align="left">Meta Description </TD>
<TD align="left"><INPUT NAME="meta_desc"  size="75" type="text"  id="meta_desc" VALUE="<?php echo $this->_tpl_vars['val']['meta_desc']; ?>
...
<tr>
<td align="left"><?php echo $this->_tpl_vars['allproducts']; ?>
</td>
</tr>
<tr>
