<?php 
 ob_start(); ?><?php /* Smarty version 2.6.19, created on 2013-02-28 18:14:34
compiled from showsubundersubcategory.html */ ?>
...
<tr>
<td colspan="3" align="left" class="content_title">Sub under Sub Category List </td>
</tr>
<tr>
...
<tr>
<td colspan="3" align="left" ><?php echo $this->_tpl_vars['showsubcatunder']; ?>
...
{
window.location = "?do=showsubundercat&action=delete&id="+id;
}
}
function edit(id,mid)
{
//alert(mid);
window.location= "?do=showsubundercat&action=disp&id="+id+"&mid="+mid;
}
</script>
<?php $_smarty_tpl_vars = $this->_tpl_vars;
