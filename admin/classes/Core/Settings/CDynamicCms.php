...
class Core_Settings_DynamicCms
{
	...
	function addDynamicPageSettings()
	{
		...
		$sluggable=	$_POST['cms_page_alias'];
		...
		$obj=new Bin_Query();
		$sql="INSERT INTO cms_table (cms_page_title,cms_page_content,cms_page_alias,cms_create_date,cms_meta_content,cms_meta_keyword) VALUES('".$_POST['cms_page_title']."','".$_POST['cms_page_content']."','".$sluggable."',NOW(),'".$_POST['cms_meta_content']."','".$_POST['cms_meta_keyword']."')";
	...
	function updateEditDynamicCms()
	{
		...
		$sql="update cms_table  set cms_page_title='".$_POST['cms_page_title']."',cms_page_alias 	='".$sluggable."',cms_page_content='".trim($_POST['cms_page_content'])."',cms_page_status='".$_POST['cms_page_status']."',cms_meta_content='".trim($_POST['cms_meta_content'])."',cms_meta_keyword='".trim($_POST['cms_meta_keyword'])."' where  	cms_id='".$_GET['id']."'"; 
		$qry=new Bin_Query();
		if($qry->updateQuery($sql))
		{
			$result = '<div class="alert alert-success">
