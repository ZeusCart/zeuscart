...
/**
 * This class contains functions to update the Google Adsense script 
 * at the admin side.
 *
 * @package  		Model_MGoogleAdSense
 * @category  		Model
...
class Model_MGoogleAdSense
{
	...
	/**
	 * Function displays a template for updating the Google Adsense script 
	 * at the admin side   
	 * 
	 * @return array
	 */
	...
	/**
	 * Function updates the Google Adsense script 
	 * at the admin side   
	 * 
	 * @return array
	 */
