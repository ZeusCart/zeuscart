...
/**
 * This class contains functions to display the admin activites at the admin side
 *
 * @package  		Model_MAdminActivity
 * @category  		Model
...
class Model_MAdminActivity
{
	...
	/**
	 * Function truncates the Admin activity records     
	 * 
	 * 
	 * @return string
	 */
