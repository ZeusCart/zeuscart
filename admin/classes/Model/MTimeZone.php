...
/**
 * This class contains functions to update the time zone settings 
 *
 * @package  		Model_MTimeZone
 * @category  		Model
...
class Model_MTimeZone
{
	...
	/**
	 * Function displays a templates for updating the time zone details 
	 * at the admin side   
	 * 
	 * @return array
	 */
	function timeZone()
	{
		...
		if($chkuser)
		{
			include('classes/Core/Settings/CTimeZone.php');
			include('classes/Display/DTimeZone.php');		
					
			$output['timezone'] =   Core_Settings_CTimeZone::timeZone();				
			$output['currentzone'] =   Core_Settings_CTimeZone::currentZone();
			Bin_Template::createTemplate('timezone.html',$output);
		}
		else
		{
	...
	/**
	 * Function updates the changes made in the time zone details 
	 * 
	 * 
	 * @return array
	 */
	...
	function updateTimeZone()
	{
		...
		if($chkuser)
		{
			...
			$output['updatezonemsg'] =   Core_Settings_CTimeZone::updateTimeZone();
			$output['timezone'] =   Core_Settings_CTimeZone::timeZone();	
			$output['currentzone'] =   Core_Settings_CTimeZone::currentZone();
			$output['currentDate']=date('l, M d, Y H:i:s');		
			$output['currency_type']=$_SESSION['currency']['currency_tocken'];		
