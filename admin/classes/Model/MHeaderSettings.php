...
/**
 * This class contains functions to display the  header settings
 *
 * @package  		Model_MHeaderSettings
 * @category  		Model
...
class Model_MHeaderSettings
{
	...
	var $output = array();	
	/**
	 * Function displays a template for show the footer link
	 *   
	 * 
	 * @return array
	 */
	function showFooterLink()
	{
		...
		if($chkuser)
		{
			...
			include('classes/Core/Settings/CHeaderSettings.php');
			include('classes/Display/DHeaderSettings.php');		
			$output['showheader'] = Core_Settings_CHeaderSettings::showFooterLink();				
			include('templates/headersettings.html');	
		}
		else
		{
	...
	/**
	 * Function displays a template for show the site settings
	 *   
	 * 
	 * @return array
	 */
	function siteSettings()
	{
		...
		if($chkuser)
		{
			include('classes/Core/Settings/CHeaderSettings.php');
			include('classes/Display/DHeaderSettings.php');		
			$output['area1'] = Core_Settings_CHeaderSettings::addLink();				
			include('templates/footersettings.html');			
		}
		else
		{
			$output['usererr'] = 'You are Not having Privilege to view this page contact your Admin for detail';
