...
/**
 * MMostSearchedKeywords
 *
 * This class contains functions to display the most searched keywords
 * 
 * @package		Model_MMostSearchedKeywords
 * @category	Model
...
class Model_MMostSearchedKeywords
{
	/**
	 * Stores the output
	 *
	...
	/**
	 * Function displays a the Most Searched Keywords in the user side
	 *   
	 * 
	 * @return array
	 */
	...
	function showMostSearchedKeywords()
	{
		...
		if($chkuser)
		{
			include("classes/Core/CMostSearchedKeywords.php");
			include("classes/Display/DMostSearchedKeywords.php");			
			$default = new Core_CMostSearchedKeywords();	
			$output['showcontent'] =$default->showMostSearchedKeywords();
			Bin_Template::createTemplate('mostsearchedkeywords.html',$output);
		}
		else
		{
