...
/**
 * MBestSellingProducts
 *
 * This class contains functions to display the best selling products 
 * at the admin side.
 * @package		Model_MBestSellingProducts
 * @category	Model
...
class Model_MBestSellingProducts
{
	/**
	 * Stores the output
	 *
	...
	/**
	 * Function displays the Best Selling Products 
	 * at the admin side   
	 * 
	 * @return array
	 */
	...
	function showBestSellingProducts()
	{
		...
		if($chkuser)
		{
			include("classes/Core/CBestSellingProducts.php");
			include("classes/Display/DBestSellingProducts.php");			
			$default = new Core_CBestSellingProducts();	
			$output['showcontent'] =$default->showBestSellingProducts();			
			Bin_Template::createTemplate('bestsellingproducts.html',$output);
		}
		else
		{
