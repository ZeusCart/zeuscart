...
/**
 * This class contains functions to update the changes made in the Admin Email Settings. 
 *
 *
 * @package  		Model_MAdminEmailSettings
 * @category  		Model
 ...
 * @version  		Version 4.0
 */
class Model_MAdminEmailSettings
{
	...
	/**
	 * Function is displays a template to update the admin Email Settings. 
	 * 
	 * 
	 * @return array
	 */
	...
	function siteEmail()
	{
		...
		$output['currentmonthincome']=(int)Core_CAdminHome::currentMonthIncome();
		...
		if($chkuser)
		{
			include("classes/Core/Settings/CAdminEmailSettings.php");
			include("classes/Display/DAdminEmailSettings.php");
			$output['siteemail'] = Core_Settings_CAdminEmailSettings::siteEmail();
			Bin_Template::createTemplate('adminemailsettings.html',$output);	
		}
		else
		{
	...
	/**
	 * Function updates the changes in the admin email settings. 
	 * 
	 * 
	 * @return array
	 */
	...
	function updateSiteEmail()
	{
		...
		if($chkuser)
		{
			include("classes/Core/Settings/CAdminEmailSettings.php");
			include("classes/Display/DAdminEmailSettings.php");
			$output['siteemailmsg'] = Core_Settings_CAdminEmailSettings::updateSiteEmail();		
			$output['siteemail'] = Core_Settings_CAdminEmailSettings::siteEmail();
			Bin_Template::createTemplate('adminemailsettings.html',$output);	
		}
		else
