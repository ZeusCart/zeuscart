...
/**
 * This class contains functions to add a HTML Content Page
 * from admin side.
 *
 * @package  		Model_MContentManagement
 * @category  		Model
...
class Model_MContentManagement
{
	
	/**
	 * Function displays a template for updating a HTML Content Page  
	 * from the admin side   
	 * 
	 * @return array
	 */
	...
	function addContent()
	{
		...
		if($chkuser)
		{
			include("classes/Core/Settings/CContentManagement.php");
			$default = new Core_Settings_CContentManagement();
			$output['addcontent']=$default->addContent();
			Bin_Template::createTemplate('contentmanagement.html',$output);	
		}
		else
		{
	...
	/**
	 * Function updates the HTML Content Page from the admin side  
	 * 
	 * 
	 * @return array
	 */
