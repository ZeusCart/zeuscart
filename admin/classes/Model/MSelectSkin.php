...
/**
 * This class contains functions to change the default skins settings 
 *
 * @package  		Model_MSelectSkin
 * @category  		Model
...
class Model_MSelectSkin
{
	...
	/**
	 * Function displays a templates for the list of skins available 
	 * 
	 * 
	 * @return array
	 */
	...
	function showSkin()
	{
		...
		if($chkuser)
		{
			...
			include("classes/Core/Settings/CSelectSkin.php");
			
			$output['showskin'] = Core_Settings_CSelectSkin::displaySkin();
			$output['currentskin'] = Core_Settings_CSelectSkin::currentSkin();
			Bin_Template::createTemplate('selectskin.html',$output);	
		}
		else
		{
	...
	/**
	 * Function updates the selected skin by the admin 
	 * 
	 * 
	 * @return array
	 */
	...
	function updateSkin()
	{
		...
		if($chkuser)
		{
			...
			include("classes/Core/Settings/CSelectSkin.php");
			$default = new Core_Settings_CSelectSkin();
			$output['updatemsg']=$default->updateSkin();
			$output['showskin']=$default->displaySkin();
			$output['currentskin'] =$default->currentSkin();
			Bin_Template::createTemplate('selectskin.html',$output);	
