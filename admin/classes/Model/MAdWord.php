 ...
 * MAdWord
 *
 * This class contains functions to display the google ad-word campaign   
 * at the admin side.
 * @package		Model_MAdWord
 * @category	Model
...
class Model_MAdWord
{
	...
	/**
	 * Function displays the Google Ad-Word Campaign 
	 * at the admin side   
	 * 
	 * @return array
	 */
	...
	function showAdWord() 
	{
		...
		if($chkuser)
		{
			include_once('classes/Core/CAdWord.php');
			$default=new Core_CAdWord();
			Bin_Template::createTemplate('adWord.html',$output);
		}
		else
		{
	...
	/**
	 * Function exports the Google Ad-Word Campaign in TSV Format 
	 * at the admin side   
	 * 
	 * @return array
	 */
	...
	function exportTSV()
	{
		include('classes/Core/CAdWord.php');
		$default = new Core_CAdWord();
		$output['excel'] = $default->googleProduct();
		Bin_Template::createTemplate('googlebase.html',$output);
	}
}
?>