...
/**
 * This class contains functions to update the admin profile
 *
 * @package  		Model_MAdminProfile
 * @category  		Model
...
class Model_MAdminProfile
{
	...
	function showAdminProfile()
	{
		...
		if($chkuser)
		{
			...
			include("classes/Core/CAdminProfile.php");
			include("classes/Display/DAdminProfile.php");
			$output['adminprofile'] = Core_CAdminProfile::showAdminProfile($Err);
			$output['msgadminproflie'] =$_SESSION['msgadminproflie'];
			Bin_Template::createTemplate('adminprofile.html',$output);	
			unset($_SESSION['msgadminproflie']);
		}
		else
		{
	...
	/**
	 * Function updates the changes made in the admin profile 
	 * 
	 * 
	 * @return array
	 */
	...
	function updateAdminProfile()
	{
		...
		if($chkuser)
		{
			...
			$obj = new Lib_CheckInputs('adminprofile');
			Core_CAdminProfile::updateAdminProfile();
		}
		else
		{
			$output['usererr'] = 'You are Not having Privilege to view this page contact your Admin for detail';
