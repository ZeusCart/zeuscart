...
/**
 * This class contains functions to get the Google Base feed data  
 * at the admin side.
 *
 * @package  		Model_MGoogleBase
 * @category  		Model
...
class Model_MGoogleBase
{
	...
	/**
	 * Function displays a template for Google products
	 *    
	 * 
	 * @return array
	 */
	...
	/**
	 * Function creates a excel file for Google base products
	 *    
	 * 
	 * @return array
	 */
	...
	function googleProduct()
	{
		...
		if($chkuser)
		{
			include('classes/Core/CGoogleBase.php');
			$default = new Core_CGoogleBase();
