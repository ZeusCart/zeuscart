...
/**
 * This class contains functions to edit and update the custom header details
 * at the admin side.
 *
 * @package  		Model_MCustomHeader
 * @category  		Model
...
class Model_MCustomHeader
{
	
	
	/**
	 * Function displays a template for updating the custom header 
	 * 
	 * 
	 * @return array
	 */
	...
	/**
	 * Function updates the changes made in the custom header 
	 * 
	 * 
	 * @return array
	 */
