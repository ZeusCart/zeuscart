...
/**
 * This class contains functions to export the products available in Excel/CSV/Tab/XML format
 * at the admin side.
 *
 * @package  		Model_MProductDataExport
 * @category  		Model
...
class Model_MProductDataExport
	{
	/**
	 * Stores the output
	 *
	...
	/**
	 * Function displays a template for product data export 
	 * 
	 * @return array
	 */
	function showTemplate()
	{
		include('classes/Core/CProductDataExport.php');
		include('classes/Display/DProductrDataExport.php');	
		...
		//$output['export'] =   Core_COrderDataExport::OrderDataExport();				

		Bin_Template::createTemplate('productdataexport.html',$output);
		}
		else
		{
	...
	/**
	 * Function exports the details of the products available in excel/csv/tab/xml format
	 * 
	 * @return array
	 */
	...
	function productDataExport()
	{
		...
		$output['export'] =   Core_CProductDataExport::productDataExport();				
