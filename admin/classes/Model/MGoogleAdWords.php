...
/**
 * This class contains functions to update the Google AdWord Campaign  
 * at the admin side.
 *
 * @package  		Model_MGoogleAdWords
 * @category  		Model
...
class Model_MGoogleAdWords
{
	...
	/**
	 * Function displays a new page for getting the Google AdWord Campaign   
	 * at the admin side
	 * 
	 * @return array
	 */
