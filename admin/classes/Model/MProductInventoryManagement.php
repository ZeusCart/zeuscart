...
/**
 * MProductInventoryManagement
 *
 * This class contains functions to edit and delete inventory 
 * at the admin side.
 * @package		Model_MProductInventoryManagement
 * @category	Model
...
class Model_MProductInventoryManagement
{
	/**
	 * Stores the output
	 *
	...
	/**
	 * Function displays the stock status for each product
	 * at the admin side   
	 * 
	 * @return array
	 */
	...
	{
		include('classes/Core/CProductInventoryManagement.php');
		include('classes/Display/DProductInventoryManagement.php');		
		...
		if($chkuser)
		{	
			$output['dispinventory'] =   Core_CProductInventoryManagement::dispInventory();				
			Bin_Template::createTemplate('ProductInventoryManagement.html',$output);
		}
		else
		{
	...
	/**
	 * Function displays a template for updating the changes in the inventory
	 * at the admin side   
	 * 
	 * @return array
	 */
	...
	function editInventory()
	{
		...
		if($chkuser)
		{	
			$output['editinventory'] =   Core_CProductInventoryManagement::editInventory();				
			Bin_Template::createTemplate('EditProductInventoryManagement.html',$output);
		}
		else
		{
			 	$output['usererr'] = 'You are Not having Privilege to view this page contact your Admin for detail';
	...
	/**
	 * Function updates the changes in the inventory 
	 * at the admin side  
	 * 
	 * @return array
	 */
	...
	function updateInventory()
	{
		...
		if($chkuser)
		{
		   Core_CProductInventoryManagement::updateInventory();				
	...
	function deleteInventory()
	{
		...
		if($chkuser)
		{
		   Core_CProductInventoryManagement::deleteInventory();				
		   header("Location:?do=productinventory");
		   exit;
