...
/**
 * This class contains functions to export all the categories in XML/Excel/TSV/CSV format
 * 
 * @package  		Model_MCategoryDataExport
 * @category  		Model
...
class Model_MCategoryDataExport
	{
	...
	/**
	 * Function displays a template for exporting the categories  
	 * 
	 * 
	 * @return array
	 */
