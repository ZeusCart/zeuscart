...
/**
 * MAdminActivityDataExport
 *
 * This class contains functions to export the admin activity from the admin side.
 *
 * @package		Model_MAdminActivityDataExport
 * @category	Model
...
class Model_MAdminActivityDataExport
	{
	...
	/**
	 * Function is used to export the admin activity report to a file format      
	 * 
	 * 
	 * @return array
	 */
	...
	function adminActivityDataExport()
	{
		...
		$output['processingorders']=(int)Core_CAdminHome::processingOrders();
		$output['deliveredorders']=(int)Core_CAdminHome::deliveredOrders();*/
		$output['export'] =Core_CAdminActivityDataExport::adminActivityDataExport();				
