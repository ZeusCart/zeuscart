...
/**
 * This class contains functions to export the orders into Excel/XML/TAB/CSV format
 * at the admin side.
 *
 * @package  		Model_MOrderDataExport
 * @category  		Model
...
class Model_MOrderDataExport
	...
	/**
	 * Function displays a template for exporting the available list of orders
	 * 
	 * 
	 * @return array
	 */
	...
	function showTemplate()
	{
		...
		if($chkuser)
		{	
		include('classes/Core/COrderDataExport.php');
		include('classes/Display/DOrderDataExport.php');		
		...
		Bin_Template::createTemplate('orderdataexport.html',$output);
		}
		else
		{
	...
	/**
	 * Function saves the list of orders as Excel/CSV/Tab/XML format 
	 * 
	 * 
	 * @return array
	 */
