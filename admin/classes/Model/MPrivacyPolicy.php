...
/**
 * This class contains functions to update the Privacy Policy for the site   
 *
 * @package  		Model_MPrivacyPolicy
 * @category  		Model
...
class Model_MPrivacyPolicy
{
	
	/**
	 * Function displays a templates for updating the privacy policy
	 *
	 * 
	 * @return array
	 */
