...
/**
 * This class contains functions to update the changes made in the doamin name. 
 *
 *
 * @package  		Model_MDomainName
 * @category  		Model
...
class Model_MDomainName
{
	...
	/**
	 * Function is displays a template to update the doamin name. 
	 * 
	 * 
	 * @return array
	 */
	...
	function domainName()
	{
		...
		if($chkuser)
		{
			include("classes/Core/Settings/CDomainName.php");
			include("classes/Display/DDomainName.php");
			$output['domainname'] = Core_Settings_CDomainName::domainName();
			Bin_Template::createTemplate('domainname.html',$output);	
		}
		else
		{
	...
	function updateDomainName()
	{
		...
		if($chkuser)
		{
			include("classes/Core/Settings/CDomainName.php");
			include("classes/Display/DDomainName.php");
			$output['domainnamemsg'] = Core_Settings_CDomainName::updateDomainName();		
			$output['domainname'] = Core_Settings_CDomainName::domainName();
			Bin_Template::createTemplate('domainname.html',$output);	
		}
		else
