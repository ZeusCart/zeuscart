...
/**
 * This class contains functions to display status of the latest orders 
 *
 * @package  		Model_MLatestOrders
 * @category  		Model
...
class Model_MLatestOrders
{
	...
	/**
	 * Function displays the status of the latest orders 
	 *    
	 * 
	 * @return array
	 */
	...
	{
		include('classes/Core/CLatestOrders.php');
		include('classes/Display/DLatestOrders.php');	
		...
		$output['latestorders'] =   Core_CLatestOrders::dispLatestOrders();				
		Bin_Template::createTemplate('LatestOrders.html',$output);
		$output['latestcustomer'] = Core_CLatestOrders::dispLatestCustomer();
