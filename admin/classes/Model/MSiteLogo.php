...
/**
 * This class contains functions to modify the site logo 
 *
 * @package  		Model_MSiteLogo
 * @category  		Model
...
class Model_MSiteLogo
{
	...
	/**
	 * Function displays a template for updating the site logo 
	 * 
	 * 
	 * @return array
	 */
	...
	/**
	 * Function updates the site logo 
	 * 
	 * 
	 * @return array
	 */
	...
	function updateSiteLogo()
	{
		...
		if($chkuser)
		{
			...
			include('classes/Display/DSiteLogo.php');		
			$output['sitelogo'] = Core_Settings_CSiteLogo::siteLogo();
			$output['sitelogomsg'] = Core_Settings_CSiteLogo::updateSiteLogo();		
			$output['sitelogo'] = Core_Settings_CSiteLogo::siteLogo();
