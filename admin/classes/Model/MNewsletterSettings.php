 ...
 * MNewsletterSettings
 *
 * This class contains functions to add and delete a news letter 
 * at the admin side.
 * @package		Model_MNewsletterSettings
 * @category	Model
...
class Model_MNewsletterSettings
{
	...
	/**
	 * Function displays the available news letters 
	 * at the admin side   
	 * 
	 * @return array
	 */
	...
	function newNewsletter()
	{
		...
		if($chkuser)
		{
			...
			Bin_Template::createTemplate('addnewsletter.html',$output);
	...
	/**
	 * Function displays a template for adding a new news letter
	 * 
	 * 
	 * @return array
	 */
	...
	/**
	 * Function displays a news letter
	 * at the admin side   
	 * 
	 * @return array
	 */
	...
	function viewNewsletter()
	{
		...
		if($chkuser)
		{
			include("classes/Core/Settings/CNewsletterSettings.php");
			$default = new Core_Settings_CNewsletterSettings();
			$output['editmessage']=$default->viewNewsletter();
			Bin_Template::createTemplate('viewnewsletter.html',$output);
		}
		else
		{
			$output['usererr'] = 'You are Not having Privilege to view this page contact your Admin for detail';
	...
	/**
	 * Function displays a news letter for updation
	 * at the admin side   
	 * 
	 * @return array
	 */
	...
	/**
	 * Function deletes a news letter
	 * at the admin side   
	 * 
	 * @return array
	 */
	...
	/**
	 * Function get the email-ids of users for sending the news letter
	 * 
	 * 
	 * @return array
	 */
	...
	/**
	 * Function get the list of subscribed users for sending the news letter 
	 *    
	 * 
	 * @return array
	 */
	...
	function subscribedUsers()
	{
		...
		if($chkuser)
		{
			include("classes/Core/Settings/CNewsletterSettings.php");
			$default = new Core_Settings_CNewsletterSettings();
			$output['showusers'] =$default ->subscribedUsers();
			Bin_Template::createTemplate('newssubscribedusers.html',$output);
		}
		else
		{
			$output['usererr'] = 'You are Not having Privilege to view this page contact your Admin for detail';
