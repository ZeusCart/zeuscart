...
/**
 * This class contains functions to update the Google analytics code 
 *
 * @package  		Model_MGoogleAnalytics
 * @category  		Model
...
class Model_MGoogleAnalytics
{
	...
	/**
	 * Function displays a template for updating the Google analytics code   
	 *    
	 * 
	 * @return array
	 */
	function googleAnalytics()
	{
		...
		if($chkuser)
		{
			include('classes/Core/Settings/CGoogleAnalytics.php');
			include('classes/Display/DGoogleAnalytics.php');		
			$output['gcode'] =   Core_Settings_CGoogleAnalytics::googleAnalyticsCode();				
			Bin_Template::createTemplate('googleanalytics.html',$output);
		}
		else
		{
	...
	/**
	 * Function updates the Google analytics code   
	 *    
	 * 
	 * @return array
	 */
	...
	function updateGoogleAnalytics()
	{
		...
		if($chkuser)
		{
			...
			$output['gcode'] =   Core_Settings_CGoogleAnalytics::googleAnalyticsCode();				
			$output['updategooglemsg'] =   Core_Settings_CGoogleAnalytics::updateGoogleAnalytics();				
			Bin_Template::createTemplate('googleanalytics.html',$output);
		}
		else
		{
