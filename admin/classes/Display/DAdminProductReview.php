...
// 		return $output;
		...
		<td class="content_list_txt1"><input type="text" name="review" size="30"  style="width:75px;" value="'.$_POST['review'].'"/></td><td class="content_list_txt1"><input type="text" size="30"  style="width:75px;" name="date" id="fromdate" value="'.$_POST['date'].'"/></td>';
		...
		//$output.='<td class="content_list_txt1"><input type="text" size="30"  style="width:75px;" name="status" value="'.$_POST['status'].'"/></td>';
