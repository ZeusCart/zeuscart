...
// 		}
	...
	function displayProductsForOrder($result,$grandtotal)
	{
		...
		if(count($result)>0)
		{
			...
			<td><span class="label ">'.$arr[0]['currency_tocken'].number_format($order_tax,2).'</span></td>
			</tr>

			<tr >
			<td colspan="3" style="text-align:right" ><strong>DISCOUNT :</strong></td>
			<td  align="center" style="padding-right:10px"><span class="label"><strong>'.$row['currency_tocken'] .number_format($discount,2).'</strong></span></td>
			</tr>
	...
	function printOrders($arr,$orderProduct)
	{
		...
		for($i=0; $i<count($arr);$i++)
		{
			...
			<tr>
			<td align="right" style="padding-right:10px">Discount:</td>
			<td>'.$arr[0]['currency_tocken'].number_format($discount,2).'</td>
			</tr>				
			<tr>
