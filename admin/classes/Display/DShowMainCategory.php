...
class Display_DShowMainCategory
{
	...
	function showCategory($arr,$flag,$paging,$prev,$next)
	{
		...
		$output.='<form name="arfrm" id="arfrm" method="post" action="?do=showmain&action=search" ><table cellspacing="0" cellpadding="0" border="0"  class="table table-striped table-bordered  table-hover">
		...
		<tbody>';	
		$output .= ' <tr class="list_search_bg"><td class="content_list_txt2"></td><td class="content_list_txt2"><input type="text"  name="catname" value="'.$_POST['catname'].'" id="catname"/></td><td class="content_list_txt2">
