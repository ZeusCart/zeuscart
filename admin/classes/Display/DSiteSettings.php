...
class Display_DSiteSettings
{
	...
	function siteSittings($arr,$recordsTime,$Err)
	{
		...
		$output.='<div class="row-fluid">
              <div class="span2">
               Favicon</div><div class="span10" style="float:left;">

                <div class="fileupload fileupload-new" data-provides="fileupload"> 
                  <div class="fileupload-new thumbnail" style="width: 200px; height: 100px;"><img src="../'.$arr['site_favicon'].'"></div><input type="hidden" name="site_favicon" value="'.$arr['site_favicon'].'"> 
                  <div class="fileupload-preview fileupload-exists thumbnail" style="max-width: 200px; max-height: 150px; line-height: 20px;"></div>
                  <div>
                    <span class="btn btn-file"><span class="fileupload-new">Select image</span><span class="fileupload-exists">Change</span><input type="file" name="site_favicon" /></span>
