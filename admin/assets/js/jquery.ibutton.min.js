...
;(function($){
    ...
    $input
    	...
    	.after('<div class="'+options.classHandle+'"><span class="handle_bg"/></div><div class="'+options.classLabelOff+'"><span><label>'+options.labelOff+'</label></span></div><div class="'+options.classLabelOn+'"><span><label>'+options.labelOn+"</label></span></div>");
    ...
    // automatically resize the control
		...
		var handleRight = width.container - width.handle - 0;
